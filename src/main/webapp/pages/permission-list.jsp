						...
						<div class="table-box">
							...
							<div class="pull-left">
								<div class="form-group form-inline">
									...
									<div>
										<%--新增按扭--%>
										<a type="button" class="btn btn-primary btn-sm" href="${pageContext.request.contextPath}/pages/permission-add.jsp"><span class="glyphicon glyphicon-plus"></span> 新增</a>
										<%--刷新按扭--%>
										<a type="button" class="btn btn-success btn-sm btn-sm " href="${pageContext.request.contextPath}/permission/findAll.do">刷新 <span class="glyphicon glyphicon-refresh"></span></a>
									</div>
									...
									<c:forEach items="${pageInfo.list}" var="p">
										<tr>
											...
											<td class="text-center">
													<%--详情--%>
												<a type="button" class="btn btn-primary btn-sm" href="${pageContext.request.contextPath}/permission/findById.do?id=${p.id}">详情</a>
													<%--删除--%>
												<a class="btn btn-danger btn-sm"
												   href="${pageContext.request.contextPath}/permission/deletePermission.do?id=${p.id}"
												   onclick="return confirm('我这么可爱,你确定要删除我吗？')">删除权限 <span class="glyphicon glyphicon-trash"></span>
												</a>
											</td>
