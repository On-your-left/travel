						...
						<div class="table-box">
							...
							<div class="pull-left">
								<div class="form-group form-inline">
									<div>
										<%--新增按扭--%>
										<a type="button" class="btn btn-primary btn-sm" href="${pageContext.request.contextPath}/pages/role-add.jsp"><span class="glyphicon glyphicon-plus"></span> 新增角色</a>
										<%--刷新按扭--%>
										<a type="button" class="btn btn-success btn-sm btn-sm " href="${pageContext.request.contextPath}/role/findAll.do">刷新 <span class="glyphicon glyphicon-refresh"></span></a>
									</div>
									...
									<c:forEach items="${pageInfo.list}" var="role">
										<tr>
											...
											<td class="text-center">
													<%--详情--%>
												<a type="button" class="btn btn-primary btn-sm" href="${pageContext.request.contextPath}/role/findById.do?id=${role.id}">详情</a>
													<%--添加权限--%>
												<a type="button" class="btn btn-success btn-sm" href="${pageContext.request.contextPath}/role/findRoleByIdAndAllPermission.do?id=${role.id}">添加权限</a>
													<%--删除--%>
												<a class="btn btn-danger btn-sm"
												   href="${pageContext.request.contextPath}/role/deleteRole.do?id=${role.id}"
