						...
						<div class="table-box">
							...
							<div class="pull-left">
								<div class="form-group form-inline">
									...
									<div>
										<%--新增按扭--%>
										<a type="button" class="btn btn-primary btn-sm" href="${pageContext.request.contextPath}/pages/user-add.jsp"><span class="glyphicon glyphicon-plus"></span> 新增用户</a>
										<%--刷新按扭--%>
										<a type="button" class="btn btn-success btn-sm btn-sm " href="${pageContext.request.contextPath}/user/findAll.do">刷新 <span class="glyphicon glyphicon-refresh"></span></a>
									...
									<c:forEach items="${pageInfo.list}" var="user">
										<tr>
											...
											<td class="text-center">
													<%--详情--%>
												<a type="button" class="btn btn-primary btn-sm" href="${pageContext.request.contextPath}/user/findById.do?id=${user.id}">详情</a>
													<%--添加角色--%>
												<a type="button" class="btn btn-success btn-sm" href="${pageContext.request.contextPath}/user/findUserByIdAndAllRole.do?id=${user.id}">添加角色</a>
													<%--删除--%>
												<a class="btn btn-danger btn-sm"
												   href="${pageContext.request.contextPath}/user/deleteUser.do?id=${user.id}"
